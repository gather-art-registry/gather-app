 ...
 * --------------------------------------------------------------------------------------- */
 ...
 function callBxSlider() {
   $('[data-call="bxslider"]').each(function() {
      ...
      var dataBxId = $(this).attr("data-bxid");
      if(dataBxId) {
        bxSliders[dataBxId] = $(this).bxSlider();
      } else {
        $(this).bxSlider();
      }
...
$(document).ready(function() { $("#artist").select2(); });

$(document).ready(function() { $("#item-availability").select2(); });
(function() {
