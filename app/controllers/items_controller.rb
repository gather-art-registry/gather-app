  ...
  private
    ...
    def item_params
      params.require(:item).permit(:name, :artist_id, :description, :price, :item_availability_id, 
        ...
        :shipping_instruction_id, :notes, :image_1, :image_2, :image_3, :image_4, :item_category_ids, :item_medium_ids, 
        item_media_attributes: [:medium_ids], item_categories_attributes: [:category_ids])
    end
end
